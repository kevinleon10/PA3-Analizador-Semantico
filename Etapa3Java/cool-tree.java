...
abstract class Feature extends TreeNode {
    ...
    public abstract void dump_with_types(PrintStream out, int n);
    public abstract void semant(SymbolTable objectTable, SymbolTable methodTable, ClassTable classTable,class_c c);
...
class method extends Feature {
	...
	if(methodTable.probe(name) != null) {
	    ...
	    classTable.semantError(c.getFilename(), c)
		.println("Se declara mas de una vez el metodo: "
			 + name.getString());
	    return;
	} 
...
class attr extends Feature {
	...
	if(objectTable.probe(name) != null) {
	    ...
	    classTable.semantError(c.getFilename(), c)
		.println("Se declara mas de una vez la variable: "
			 + name.getString());
...
class assign extends Expression {
	...
	AbstractSymbol a = (AbstractSymbol) objectTable.lookup(name);
	 ...
	 if(a == null) {
	    classTable.semantError(c.getFilename(), c)
		.println("Se asigna a la variable: "
			 + name.getString() + ", la cual no ha sido declarada");
	    ...
	    classTable.semantError(c.getFilename(), c)
		.println("Se asigna a una variable de tipo "
			 + a.getString() + " otra de tipo "
...
class cond extends Expression {
	...
	if(!pred.get_type().equals(TreeConstants.Bool)) {
	    classTable.semantError(c.getFilename(), c)
		.println("Se espera un Bool en la condicion del if, sin embargos se recibe una variable de tipo: " + pred.get_type().getString());
	}
...
class plus extends Expression {
	...
	if(!e1.get_type().equals(TreeConstants.Int) ||
	   !e2.get_type().equals(TreeConstants.Int)) {
	    ...
	    classTable.semantError(c.getFilename(), c)
		.println("Se asigna a un entero lo siguiente: "
...
class eq extends Expression {
	...
	if(!classTable.validComparisonTypes(e1, e2)) {
	    classTable.semantError(c.getFilename(), c)
		.println("Se compara una variable del tipo "
			 + e1.get_type().getString() + " con otra del tipo "
			 + e2.get_type().getString());
...
class object extends Expression {
	...
	if(name.equals(TreeConstants.self) ||
	   name.equals(TreeConstants.SELF_TYPE)) {
	    ...
	    classTable.semantError(c.getFilename(), c)
		.println("Se referencia a la variable " + name + ", la cual no existe");
